...
class HistoryPage:
    def __init__(self, gui, template):
        ...
        self.watchlist_combo.bind("<<ComboboxSelected>>", self.combobox_selected)
    ...
    def update_data(self, product_data):
        ...
        self.stat_canvas.itemconfig(
            ...
            {product_data['current_date']}""")

        self.stat_canvas.itemconfig(
            self.low_price_text,
            text=f"""Lowest Price:\n
            ${product_data['lowest_price']}\n
            {product_data['lowest_date']}""")

        self.stat_canvas.itemconfig(
            self.high_price_text,
            text=f"""Highest Price:\n
            ${product_data['highest_price']}\n
            {product_data['highest_date']}""")
